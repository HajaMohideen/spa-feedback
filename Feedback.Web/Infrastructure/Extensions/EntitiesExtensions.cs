...
namespace Feedback.Web.Infrastructure.Extensions
{
    public static class EntitiesExtensions
    {
        ...
        public static void UpdateUsers(this Users users, UsersViewModel usersViewModel)
        {
            users.Name = usersViewModel.username;
            users.Subject = usersViewModel.subject;
            users.Email = usersViewModel.email;
            users.Feedback = usersViewModel.feedback;
        }
